...
SAMPLE_TRADES = [
    {"analyst": "fifi",     "ticker": "SPY",  "strike": "580C", "expiry": "5/9",  "price": "4.10", "status": "Closed"},
    {"analyst": "clark",    "ticker": "NVDA", "strike": "870P", "expiry": "5/9",  "price": "3.60", "status": "Closed"},
    {"analyst": "braamski", "ticker": "AAPL", "strike": "195C", "expiry": "5/16", "price": "4.80", "status": "Trimmed"},
    {"analyst": "tony",     "ticker": "QQQ",  "strike": "470P", "expiry": "5/9",  "price": "1.85", "status": "Closed"},
    {"analyst": "zeph",     "ticker": "META", "strike": "550C", "expiry": "5/16", "price": "4.20", "status": "Closed"},
    {"analyst": "bigmac",   "ticker": "TSLA", "strike": "265C", "expiry": "5/9",  "price": "3.90", "status": "Closed"},
]
...
async def run_test_eod(bot):
    today = date.today().isoformat()
    print(f"[EOD] Running TEST recap with sample data")
